...
//             + "WHERE r.id = :id")
        ...
        @NamedQuery(name = "Space.findByIdWithTimeline", query ="SELECT s FROM Space s LEFT JOIN FETCH s.timelines t WHERE s.spaceId = :id"),
        @NamedQuery(name = "Space.findByIdWithTimelineDay", query ="SELECT s FROM Space s LEFT JOIN FETCH s.timelines t WHERE s.spaceId = :id AND t.weekday = :wd"),
