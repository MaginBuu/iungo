        ...
        <form class="custom-form">
            ...
            <div class="form-row form-group">
                <div class="col-sm-3 label-column">
                    <label path="userP" class="col-form-label">Teacher </label></div>
                <div class="col-sm-7 input-column">
                    <select class="selectpicker" data-live-search="true" data-width="100%" multiple="true" id="teacher" name="teacher">
